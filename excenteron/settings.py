"""
Django settings for excenteron project.
...
SECRET_KEY = '!-)l2mk5eff71b=n6pi+py$umra3)wg9bw&r$kji766&8^i6=8'
...
WSGI_APPLICATION = 'excenteron.wsgi.application'
